...
(function(factory) {
   ...
   ********************/
        ...
        _setFlag: function(countryCode) {
            ...
            var code = countryCode ?  this.selectedCountryData.dialCode : "Unknown";
            this.selectedFlagInner.parent().attr("title", title);
            this.selectedFlagInner.parent().attr("code", code);
            if (this.options.separateDialCode) {
