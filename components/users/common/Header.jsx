...
export default function Header({}) {
    ...
    return (
<>
<style jsx>{`.dark .dark\:divide-gray-700 > :not([hidden]) ~ :not([hidden]) {
...
<div className="fixed w-full flex flex-row items-center justify-between h-14 text-white z-10">
  <div className="flex items-center justify-start md:justify-center pl-3 w-14 md:w-64 h-14 bg-blue-800 dark:bg-gray-800 border-none">
    <Image width={"0"} height={"0"} className="w-7 h-7 md:w-10 md:h-10 mr-2 rounded-md overflow-hidden" src="https://therminic2018.eu/wp-content/uploads/2018/07/dummy-avatar.jpg" alt="" />
    <span className="hidden md:block">CNS</span>
  </div>
  <div className="flex justify-between items-center h-14 bg-blue-800 dark:bg-gray-800 header-right">
    ...
    <ul className="flex items-center">
      ...
      <li>
        <a onClick={() => signOut({redirect: true, callbackUrl: "/login"})} href="#" className="flex items-center mr-4 hover:text-blue-100">
